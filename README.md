...
Implementing VGG 11 like architecture on CIFAR 10 dataset
 ...
 # Experiment
 In this project a VGG 11 like network was implemented and trained on CIFAR 10 dataset which consists of  10 classes (Original was trained on Image net with a 1000 classes), To adapt this architecture effectively for the cifar 10 32x32 pixel images the first fully connected layer was changed to 512 and in result gave us a parameter count of  28.1 million instead of the 133 milion parameters that was adopted in the VGG paper.
