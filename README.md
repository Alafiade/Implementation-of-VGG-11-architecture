...
Implementing VGG 11 like architecture on CIFAR 10 dataset
 ...
 # Experiment
 In this project a VGG 11 like network was implemented and trained on CIFAR 10 dataset which consists of  10 classes (Original was trained on Image net with a 1000 classes), Due to the modification of the final classification layer the model has a total parameter count of 123 million instead of the  133 million parameters that was reported in the original paper.
